...
// Display the results
console.log("The area of a piece of paper with a length of "+length+", and a width of "+width+" is "+area+"units squared");
console.log("The same piece of paper has a perimeter of "+perimeter+"units");
